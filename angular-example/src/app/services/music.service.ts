...
export class MusicService {
	...
	private _currentlyPlayingSongVolumeChangeSubject: BehaviorSubject<number> = new BehaviorSubject(this._storageService.getOrDefault<number>(StorageItems.Volume, 1));
	private _isPlayingCollectionSubject: BehaviorSubject<boolean> = new BehaviorSubject(false);
	private _isRepeatingCollectionSubject: BehaviorSubject<boolean> = new BehaviorSubject(this._storageService.getOrDefault<boolean>(StorageItems.IsRepeatingCollection, false));
	private _isShufflingCollectionSubject: BehaviorSubject<boolean> = new BehaviorSubject(this._storageService.getOrDefault<boolean>(StorageItems.IsShufflingCollection, false));
	...
	public playSong(id: number, fromCollection: boolean = false): void {
		...
		this._musicAgent.getSongById(id).subscribe(song => {
	...
	public setVolume(volume: number): void {
		...
		this._storageService.set(StorageItems.Volume, volume);
	}

	public setRepeatCollection(isRepeat: boolean): void {
		this._isRepeatingCollectionSubject.next(isRepeat);
		this._storageService.set(StorageItems.IsRepeatingCollection, isRepeat);
	}
	...
	public setShuffleCollection(isShuffle: boolean): void {
		...
		this._storageService.set(StorageItems.IsShufflingCollection, isShuffle);
	}
